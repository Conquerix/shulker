...
with lib;
let
  cfg = config.shulker.system.modules.crafty_controller;
in
{
  options.shulker.system.modules.crafty_controller = {
  ...
  config = mkIf cfg.enable {
    ...
    environment = mkIf (config.shulker.system.modules.impermanence.enable) {
