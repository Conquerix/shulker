# Run Pangolin, its Gerbil tunnel endpoint, and Traefik as one systemd-managed stack.
...
with lib;
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Traefik shares Gerbil's network namespace and uses the ports published there.
    ...
    # Stop containers and their network together; bind-mounted application state survives.
